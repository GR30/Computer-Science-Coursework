...
public class LockerSetting extends AppCompatActivity {
    ...
    RelativeLayout realative_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefrence = this.getSharedPreferences("Lock", Context.MODE_PRIVATE);
        realative_layout = (RelativeLayout) findViewById(R.id.rl);
        new AppChanges(this,realative_layout);
        ...
        if (prefrence.getString("status","") == "ON") {
        ...
        lock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (lock.isChecked()) {
                    prefrence.edit().putString("status","ON").commit();
                }
                else {
                    prefrence.edit().putString("status","OFF").commit();
                }
            }
        });
